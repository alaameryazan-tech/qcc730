...
typedef void (*nt_gpio_init_t)(void);
typedef void (*nt_gpio_pin_mode_t)(gpio_register_t* GPIOx,uint32_t Pin, uint32_t Mode);
typedef void (*nt_gpio_pin_write_t)(gpio_register_t *GPIOx,uint32_t pin,GPIO_PinState val);
typedef uint32_t (*nt_gpio_pin_read_level_t)(gpio_register_t *GPIOx);
typedef void (*nt_gpio_init_enable_root_clock_t)(void);
typedef void (*nt_gpio_init_disable_root_clock_t)(void);
typedef void (*nt_gpio_preset_t)(void);
typedef void (*nt_gpio_interrupt_config_t)(gpio_register_t* GPIOx,uint8_t Pin,uint8_t sensitive_status,uint8_t active_status);
typedef uint32_t (*nt_gpio_pin_read_mode_t)(gpio_register_t* GPIOx);
typedef void (*nt_gpio_interrupt_enable_t)(void);

typedef struct nt_gpio_api_s{
    nt_gpio_init_t nt_gpio_init_pfn;
    nt_gpio_pin_mode_t nt_gpio_pin_mode_pfn;
    nt_gpio_pin_write_t nt_gpio_pin_write_pfn;
    nt_gpio_pin_read_level_t nt_gpio_pin_read_level_pfn;
    nt_gpio_init_enable_root_clock_t nt_gpio_init_enable_root_clock_pfn;
    nt_gpio_init_disable_root_clock_t nt_gpio_init_disable_root_clock_pfn;
    nt_gpio_preset_t nt_gpio_preset_pfn;
    nt_gpio_interrupt_config_t nt_gpio_interrupt_config_pfn;
    nt_gpio_pin_read_mode_t nt_gpio_pin_read_mode_pfn;
    nt_gpio_interrupt_enable_t nt_gpio_interrupt_enable_pfn;
}nt_gpio_api_t;
