...
/** Try again. */
#define QAPI_NET_ERR_AGAIN ((qapi_Status_t)(__QAPI_ERROR(QAPI_MOD_NETWORKING, 26)))
...
#define QAPI_NET_WEBSOCKET_STATUS_HANDSHAKE_INVALID_SUBPROTOCOL \
    ((qapi_Status_t)(__QAPI_ERROR(QAPI_MOD_NETWORKING, 102)))
 ...
 * HTTPC status codes
 */
/** Connection to server has not been established yet */
#define QAPI_NET_STATUS_HTTPC_NONEXISTENT_SESSION ((qapi_Status_t)(__QAPI_ERROR(QAPI_MOD_NETWORKING, 110)))

/** Connecting to server failed. */
#define QAPI_NET_STATUS_HTTPC_CONNECT_FAILED ((qapi_Status_t)(__QAPI_ERROR(QAPI_MOD_NETWORKING, 111)))

/** Socket send failed. */
#define QAPI_NET_STATUS_HTTPC_SOCKET_SEND_FAILED ((qapi_Status_t)(__QAPI_ERROR(QAPI_MOD_NETWORKING, 112)))

/** Memory allocation error. */
#define QAPI_NET_STATUS_HTTPC_NO_MEMORY QAPI_ERR_NO_MEMORY

/** Have not got the response for previous HTTP request. */
#define QAPI_NET_STATUS_HTTPC_BUSY QAPI_ERR_BUSY

/** Invalid parameter. */
#define QAPI_NET_STATUS_HTTPC_INVALID_PARAM QAPI_ERR_INVALID_PARAM

/** Error with SSL connection. */
#define QAPI_NET_STATUS_HTTPC_SSL_CONN_ERROR QAPI_ERR_SSL_CONN

/** Socket creation failed. */
#define QAPI_NET_STATUS_HTTPC_SOCKET_CREATION_FAILED ((qapi_Status_t)(__QAPI_ERROR(QAPI_MOD_NETWORKING, 113)))

#define QAPI_NET_STATUS_HTTPC_END ((qapi_Status_t)(__QAPI_ERROR(QAPI_MOD_NETWORKING, 119)))

/* socket pending packet overflow*/
#define QAPI_SOCKET_TX_OVERFLOW ((qapi_Status_t)(__QAPI_ERROR(QAPI_MOD_NETWORKING, 120)))
