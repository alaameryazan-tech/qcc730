    ...
    namespace app {
        ...
        namespace Clusters {
            ...
            namespace AdministratorCommissioning {
                ...
                void DispatchServerCommand(CommandHandler *apCommandObj, const ConcreteCommandPath &aCommandPath,
                    ...
                    bool wasHandled = false;
                    {
                        switch (aCommandPath.mCommandId) {
                            case Commands::MoveToHue::Id: {
                                ...
                                TLVError = DataModel::Decode(aDataTlv, commandData);
                                if (TLVError == CHIP_NO_ERROR) {
                                    wasHandled = emberAfColorControlClusterMoveToHueCallback(apCommandObj, aCommandPath,
                                                                                             commandData);
                                }
                                break;
                            }
                            case Commands::MoveHue::Id: {
                                ...
                                TLVError = DataModel::Decode(aDataTlv, commandData);
                                if (TLVError == CHIP_NO_ERROR) {
                                    wasHandled = emberAfColorControlClusterMoveHueCallback(apCommandObj, aCommandPath,
                                                                                           commandData);
                                }
                                break;
                            }
                            case Commands::StepHue::Id: {
                                ...
                                TLVError = DataModel::Decode(aDataTlv, commandData);
                                if (TLVError == CHIP_NO_ERROR) {
                                    wasHandled = emberAfColorControlClusterStepHueCallback(apCommandObj, aCommandPath,
                                                                                           commandData);
                                }
                                break;
                            }
                            ...
                            case Commands::MoveColor::Id: {
                                ...
                                TLVError = DataModel::Decode(aDataTlv, commandData);
                                if (TLVError == CHIP_NO_ERROR) {
                                    wasHandled = emberAfColorControlClusterMoveColorCallback(apCommandObj, aCommandPath,
                                                                                             commandData);
                                }
                                break;
                            }
                            case Commands::StepColor::Id: {
                                ...
                                TLVError = DataModel::Decode(aDataTlv, commandData);
                                if (TLVError == CHIP_NO_ERROR) {
                                    wasHandled = emberAfColorControlClusterStepColorCallback(apCommandObj, aCommandPath,
                                                                                             commandData);
                                }
                                break;
                            }
                    ...
                    bool wasHandled = false;
                    {
                        switch (aCommandPath.mCommandId) {
                            case Commands::ResetCounts::Id: {
                                ...
                                TLVError = DataModel::Decode(aDataTlv, commandData);
                                if (TLVError == CHIP_NO_ERROR) {
                                    wasHandled = emberAfEthernetNetworkDiagnosticsClusterResetCountsCallback(
                                        apCommandObj, aCommandPath, commandData);
                                }
                                break;
                            }
                    ...
                    bool wasHandled = false;
                    {
                        switch (aCommandPath.mCommandId) {
                            ...
                            case Commands::TriggerEffect::Id: {
                                ...
                                TLVError = DataModel::Decode(aDataTlv, commandData);
                                if (TLVError == CHIP_NO_ERROR) {
                                    wasHandled = emberAfIdentifyClusterTriggerEffectCallback(apCommandObj, aCommandPath,
                                                                                             commandData);
                                }
                                break;
                            }
                    ...
                    bool wasHandled = false;
                    {
                        switch (aCommandPath.mCommandId) {
                            ...
                            case Commands::Move::Id: {
                                ...
                                if (TLVError == CHIP_NO_ERROR) {
                                    wasHandled =
                                        emberAfLevelControlClusterMoveCallback(apCommandObj, aCommandPath, commandData);
                                }
                                break;
                            }
                            case Commands::Step::Id: {
                                ...
                                if (TLVError == CHIP_NO_ERROR) {
                                    wasHandled =
                                        emberAfLevelControlClusterStepCallback(apCommandObj, aCommandPath, commandData);
                                }
                                break;
                            }
                            case Commands::Stop::Id: {
                                ...
                                if (TLVError == CHIP_NO_ERROR) {
                                    wasHandled =
                                        emberAfLevelControlClusterStopCallback(apCommandObj, aCommandPath, commandData);
                                }
                                break;
                            }
                    ...
                    bool wasHandled = false;
                    {
                        switch (aCommandPath.mCommandId) {
                            ...
                            case Commands::OffWithEffect::Id: {
                                ...
                                TLVError = DataModel::Decode(aDataTlv, commandData);
                                if (TLVError == CHIP_NO_ERROR) {
                                    wasHandled = emberAfOnOffClusterOffWithEffectCallback(apCommandObj, aCommandPath,
                                                                                          commandData);
                                }
                                break;
                            }
                            ...
                            case Commands::OnWithTimedOff::Id: {
                                ...
                                TLVError = DataModel::Decode(aDataTlv, commandData);
                                if (TLVError == CHIP_NO_ERROR) {
                                    wasHandled = emberAfOnOffClusterOnWithTimedOffCallback(apCommandObj, aCommandPath,
                                                                                           commandData);
                                }
                                break;
                            }
