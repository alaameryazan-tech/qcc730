...
/** Flag used to override server authentication*/
#define QAPI_NET_SSL_NO_SERVER_AUTH (0xA5A55A5A)
...
Use QAPI_WLAN_ENABLE_E as the parameter for enabling and #QAPI_WLAN_DISABLE_E
for disabling WLAN.
