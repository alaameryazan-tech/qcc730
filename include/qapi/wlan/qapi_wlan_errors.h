 ...
 *
 * @brief WLAN error definitions
 *
 * @details This section provides the unique error codes for Wi-Fi modules.
 */
...
#define QAPI_WLAN_ERR_BUS_ERROR                  	 ((qapi_Status_t)(__QAPI_ERROR(QAPI_MOD_WIFI,  37)))

/** Invalid task ID. */
#define QAPI_WLAN_ERR_QOSAL_INVALID_TASK_ID          ((qapi_Status_t)(__QAPI_ERROR(QAPI_MOD_WIFI,  38)))
/** Invalid parameter. */
#define QAPI_WLAN_ERR_QOSAL_INVALID_PARAMETER        ((qapi_Status_t)(__QAPI_ERROR(QAPI_MOD_WIFI,  39)))
/** Invalid pointer. */
#define QAPI_WLAN_ERR_QOSAL_INVALID_POINTER          ((qapi_Status_t)(__QAPI_ERROR(QAPI_MOD_WIFI,  40)))
/** Object already exists. */
#define QAPI_WLAN_ERR_QOSAL_ALREADY_EXISTS           ((qapi_Status_t)(__QAPI_ERROR(QAPI_MOD_WIFI,  41)))
/** Invalid event. */
#define QAPI_WLAN_ERR_QOSAL_INVALID_EVENT            ((qapi_Status_t)(__QAPI_ERROR(QAPI_MOD_WIFI,  42)))
/** Event timed out. */
#define QAPI_WLAN_ERR_QOSAL_EVENT_TIMEOUT            ((qapi_Status_t)(__QAPI_ERROR(QAPI_MOD_WIFI,  43)))
/** Incorrect mutex. */
#define QAPI_WLAN_ERR_QOSAL_INVALID_MUTEX            ((qapi_Status_t)(__QAPI_ERROR(QAPI_MOD_WIFI,  44)))
/** Specified task is locked by another thread. */
#define QAPI_WLAN_ERR_QOSAL_TASK_ALREADY_LOCKED      ((qapi_Status_t)(__QAPI_ERROR(QAPI_MOD_WIFI,  45)))
/** Specified mutex is locked by another thread. */
#define QAPI_WLAN_ERR_QOSAL_MUTEX_ALREADY_LOCKED     ((qapi_Status_t)(__QAPI_ERROR(QAPI_MOD_WIFI,  46)))
/** No memory is available for the operation. */
#define QAPI_WLAN_ERR_QOSAL_OUT_OF_MEMORY            ((qapi_Status_t)(__QAPI_ERROR(QAPI_MOD_WIFI,  47)))
/** WLAN image fails verification. */
#define QAPI_WLAN_ERR_IMG_VERIFY_ERROR            	 ((qapi_Status_t)(__QAPI_ERROR(QAPI_MOD_WIFI,  48)))
/** Fails to open or read flash. */
#define QAPI_WLAN_ERR_FLASH_ERROR            		 ((qapi_Status_t)(__QAPI_ERROR(QAPI_MOD_WIFI,  49)))
