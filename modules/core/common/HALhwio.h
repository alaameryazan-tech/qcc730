...
#ifdef NEUTRINO_SIMV
#include "dv_socket_api.h"
#elif defined(NEUTRINO_T32)
#include "trace32_api.h"
#endif

#ifdef WLAN_DEVICE_TYPE_SFC
extern uint32 plat_use_sfc;
#endif
...
#define HWIO_INFI2(io, index1, index2, field) \
    (HWIO_INMI2(io, index1, index2, HWIO_FMSK(io, field)) >> HWIO_SHFT(io, field))
#define HWIO_INFI3(io, index1, index2, index3, field) \
    (HWIO_INMI3(io, index1, index2, index3, HWIO_FMSK(io, field)) >> HWIO_SHFT(io, field))
...
#define HWIO_INXMI3(base, hwiosym, index1, index2, index3, mask) \
    __msmhwio_inxmi3(base, hwiosym, index1, index2, index3, mask)
...
#define HWIO_INXFI2(base, io, index1, index2, field) \
    (HWIO_INXMI2(base, io, index1, index2, HWIO_FMSK(io, field)) >> HWIO_SHFT(io, field))
#define HWIO_INXFI3(base, io, index1, index2, index3, field) \
    (HWIO_INXMI3(base, io, index1, index2, index3, HWIO_FMSK(io, field)) >> HWIO_SHFT(io, field))
/** @} */
...
#define HWIO_OUTMI3(hwiosym, index1, index2, index3, mask, val) \
    __msmhwio_outmi3(hwiosym, index1, index2, index3, mask, val)

#define HWIO_OUTF(io, field, val) HWIO_OUTM(io, HWIO_FMSK(io, field), (uint32)(val) << HWIO_SHFT(io, field))
#define HWIO_OUTFI(io, index, field, val) \
    HWIO_OUTMI(io, index, HWIO_FMSK(io, field), (uint32)(val) << HWIO_SHFT(io, field))
#define HWIO_OUTFI2(io, index1, index2, field, val) \
    HWIO_OUTMI2(io, index1, index2, HWIO_FMSK(io, field), (uint32)(val) << HWIO_SHFT(io, field))
#define HWIO_OUTFI3(io, index1, index2, index3, field, val) \
    HWIO_OUTMI3(io, index1, index2, index3, HWIO_FMSK(io, field), (uint32)(val) << HWIO_SHFT(io, field))

#define HWIO_OUTV(io, field, val) \
    HWIO_OUTM(io, HWIO_FMSK(io, field), (uint32)(HWIO_VAL(io, field, val)) << HWIO_SHFT(io, field))
#define HWIO_OUTVI(io, index, field, val) \
    HWIO_OUTMI(io, index, HWIO_FMSK(io, field), (uint32)(HWIO_VAL(io, field, val)) << HWIO_SHFT(io, field))
#define HWIO_OUTVI2(io, index1, index2, field, val) \
    HWIO_OUTMI2(io, index1, index2, HWIO_FMSK(io, field), (uint32)(HWIO_VAL(io, field, val)) << HWIO_SHFT(io, field))
#define HWIO_OUTVI3(io, index1, index2, index3, field, val)       \
    HWIO_OUTMI3(io, index1, index2, index3, HWIO_FMSK(io, field), \
                (uint32)(HWIO_VAL(io, field, val)) << HWIO_SHFT(io, field))
...
#define HWIO_OUTXI3(base, hwiosym, index1, index2, index3, val) \
    __msmhwio_outxi3(base, hwiosym, index1, index2, index3, val)
...
#define HWIO_OUTXM3(base, hwiosym, mask1, mask2, mask3, val1, val2, val3) \
    __msmhwio_outxm3(base, hwiosym, mask1, mask2, mask3, val1, val2, val3)
#define HWIO_OUTXM4(base, hwiosym, mask1, mask2, mask3, mask4, val1, val2, val3, val4) \
    __msmhwio_outxm4(base, hwiosym, mask1, mask2, mask3, mask4, val1, val2, val3, val4)
#define HWIO_OUTXMI(base, hwiosym, index, mask, val) __msmhwio_outxmi(base, hwiosym, index, mask, val)
#define HWIO_OUTXMI2(base, hwiosym, index1, index2, mask, val) \
    __msmhwio_outxmi2(base, hwiosym, index1, index2, mask, val)
#define HWIO_OUTXMI3(base, hwiosym, index1, index2, index3, mask, val) \
    __msmhwio_outxmi3(base, hwiosym, index1, index2, index3, mask, val)

#define HWIO_OUTXF(base, io, field, val) \
    HWIO_OUTXM(base, io, HWIO_FMSK(io, field), (uint32)(val) << HWIO_SHFT(io, field))
#define HWIO_OUTX2F(base, io, field1, field2, val1, val2)                                                        \
    HWIO_OUTXM2(base, io, HWIO_FMSK(io, field1), HWIO_FMSK(io, field2), (uint32)(val1) << HWIO_SHFT(io, field1), \
                (uint32)(val2) << HWIO_SHFT(io, field2))
#define HWIO_OUTX3F(base, io, field1, field2, field3, val1, val2, val3)                           \
    HWIO_OUTXM3(base, io, HWIO_FMSK(io, field1), HWIO_FMSK(io, field2), HWIO_FMSK(io, field3),    \
                (uint32)(val1) << HWIO_SHFT(io, field1), (uint32)(val2) << HWIO_SHFT(io, field2), \
                (uint32)(val3) << HWIO_SHFT(io, field3))
#define HWIO_OUTX4F(base, io, field1, field2, field3, field4, val1, val2, val3, val4)                                 \
    HWIO_OUTXM4(base, io, HWIO_FMSK(io, field1), HWIO_FMSK(io, field2), HWIO_FMSK(io, field3), HWIO_FMSK(io, field4), \
                (uint32)(val1) << HWIO_SHFT(io, field1), (uint32)(val2) << HWIO_SHFT(io, field2),                     \
                (uint32)(val3) << HWIO_SHFT(io, field3), (uint32)(val4) << HWIO_SHFT(io, field4))

#define HWIO_OUTXFI(base, io, index, field, val) \
    HWIO_OUTXMI(base, io, index, HWIO_FMSK(io, field), (uint32)(val) << HWIO_SHFT(io, field))
#define HWIO_OUTXFI2(base, io, index1, index2, field, val) \
    HWIO_OUTXMI2(base, io, index1, index2, HWIO_FMSK(io, field), (uint32)(val) << HWIO_SHFT(io, field))
#define HWIO_OUTXFI3(base, io, index1, index2, index3, field, val) \
    HWIO_OUTXMI3(base, io, index1, index2, index3, HWIO_FMSK(io, field), (uint32)(val) << HWIO_SHFT(io, field))

#define HWIO_OUTXV(base, io, field, val) \
    HWIO_OUTXM(base, io, HWIO_FMSK(io, field), (uint32)(HWIO_VAL(io, field, val)) << HWIO_SHFT(io, field))
#define HWIO_OUTXVI(base, io, index, field, val) \
    HWIO_OUTXMI(base, io, index, HWIO_FMSK(io, field), (uint32)(HWIO_VAL(io, field, val)) << HWIO_SHFT(io, field))
#define HWIO_OUTXVI2(base, io, index1, index2, field, val)       \
    HWIO_OUTXMI2(base, io, index1, index2, HWIO_FMSK(io, field), \
                 (uint32)(HWIO_VAL(io, field, val)) << HWIO_SHFT(io, field))
#define HWIO_OUTXVI3(base, io, index1, index2, index3, field, val)       \
    HWIO_OUTXMI3(base, io, index1, index2, index3, HWIO_FMSK(io, field), \
                 (uint32)(HWIO_VAL(io, field, val)) << HWIO_SHFT(io, field))
/** @} */
...
#define __msmhwio_inxmi3(base, hwiosym, index1, index2, index3, mask) \
    HWIO_##hwiosym##_INMI3(base, index1, index2, index3, mask)
...
#define __msmhwio_outxi3(base, hwiosym, index1, index2, index3, val) \
    HWIO_##hwiosym##_OUTI2(base, index1, index2, index3, val)
#define __msmhwio_outxm(base, hwiosym, mask, val) \
    out_dword_masked_ns(__msmhwio_addrx(base, hwiosym), mask, val, __msmhwio_inx(base, hwiosym))

#define __msmhwio_outxm2(base, hwiosym, mask1, mask2, val1, val2)                                              \
    out_dword(__msmhwio_addrx(base, hwiosym), ((__msmhwio_inx(base, hwiosym) & (uint32_t)(~(mask1 | mask2))) | \
                                               (((uint32_t)((val1) & (mask1))) | ((uint32_t)((val2) & (mask2))))))

#define __msmhwio_outxm3(base, hwiosym, mask1, mask2, mask3, val1, val2, val3)         \
    out_dword(__msmhwio_addrx(base, hwiosym),                                          \
              ((__msmhwio_inx(base, hwiosym) & (uint32_t)(~(mask1 | mask2 | mask3))) | \
               (((uint32_t)((val1) & (mask1))) | ((uint32_t)((val2) & (mask2))) | ((uint32_t)((val3) & (mask3))))))

#define __msmhwio_outxm4(base, hwiosym, mask1, mask2, mask3, mask4, val1, val2, val3, val4)                        \
    out_dword(__msmhwio_addrx(base, hwiosym),                                                                      \
              ((__msmhwio_inx(base, hwiosym) & (uint32_t)(~(mask1 | mask2 | mask3 | mask4))) |                     \
               (((uint32_t)((val1) & (mask1))) | ((uint32_t)((val2) & (mask2))) | ((uint32_t)((val3) & (mask3))) | \
                ((uint32_t)((val4) & (mask4))))))

#define __msmhwio_outxmi(base, hwiosym, index, mask, val) \
    out_dword_masked_ns(__msmhwio_addrxi(base, hwiosym, index), mask, val, __msmhwio_inxi(base, hwiosym, index))
#define __msmhwio_outxmi2(base, hwiosym, idx1, idx2, mask, val) HWIO_##hwiosym##_OUTMI2(base, idx1, idx2, mask, val)
#define __msmhwio_outxmi3(base, hwiosym, idx1, idx2, idx3, mask, val) \
    HWIO_##hwiosym##_OUTMI3(base, idx1, idx2, idx3, mask, val)
...
#ifdef NEUTRINO_SIMV
/*
 * Input/output port macros for RTL based Simulation
 */
#define __inp(port)   (uint8_t) dvRead((uint32_t)(port))
#define __inpw(port)  (uint16_t) dvRead((uint32_t)(port))
#define __inpdw(port) (uint32_t) dvRead((uint32_t)(port))

#define __outp(port, val)   dvWrite(((port)), ((uint8_t)(val)))
#define __outpw(port, val)  dvWrite(((port)), ((uint16_t)(val)))
#define __outpdw(port, val) dvWrite(((port)), ((uint32_t)(val)))

#define HAL_REG_WR(reg_addr, data) dvWrite((uint32_t)(reg_addr), (uint32_t)data)
#define HAL_REG_RD(reg_addr)       (uint32_t) dvRead((uint32_t)(reg_addr))

#elif defined(NEUTRINO_T32)
/*
 * Input/output port macros for accessing register via Trace32 .
 */
#define __inp(port)   (uint8_t) trace32_read((uint32_t)(port))
#define __inpw(port)  (uint16_t) trace32_read((uint32_t)(port))
#define __inpdw(port) (uint32_t) trace32_read((uint32_t)(port))

#define __outp(port, val)   trace32_write(((port)), ((uint8_t)(val)))
#define __outpw(port, val)  trace32_write(((port)), ((uint16_t)(val)))
#define __outpdw(port, val) trace32_write(((port)), ((uint32_t)(val)))

#define HAL_REG_WR(reg_addr, data) trace32_write((uint32_t)(reg_addr), (uint32_t)data)
#define HAL_REG_RD(reg_addr)       (uint32_t) trace32_read((uint32_t)(reg_addr))
...
#define out_byte_masked_ns(io, mask, val, current_reg_content) \
    out_byte(io, ((current_reg_content & (uint16)(~(mask))) | ((uint16)((val) & (mask)))))
...
#define out_word_masked_ns(io, mask, val, current_reg_content) \
    out_word(io, ((current_reg_content & (uint16)(~(mask))) | ((uint16)((val) & (mask)))))
...
#define out_dword_masked_ns(io, mask, val, current_reg_content) \
    out_dword(io, ((current_reg_content & (uint32)(~(mask))) | ((uint32)((val) & (mask)))))

#define out_dword_masked_ns_shift(io, mask, val, current_reg_content, shift) \
    out_dword(io, ((current_reg_content & (uint32)(~(mask))) | (((uint32)((val) & (mask))) << shift)))
/** @endcond */
