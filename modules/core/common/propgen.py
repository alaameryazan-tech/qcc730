...
def PrintConfig(ModName, CONFIG, devcfgdatafilename, ConfigType ):
   ...
   CONFIG_DATA.write ("#include \"DALStdDef.h\" \n")
   #CONFIG_DATA.write ("#include \"wifi_parser.c\" \n")
   ...
   CONFIG_DATA.write ("\nint parse_dev( uint32 " + dalprop_propbin_str + " );\n")
...
def main():
   ...
   if ConfigFileName != None:
      CONFIG = open(ConfigFileName, 'a')   #### output to DALConfig_devcfg.c(config file)
