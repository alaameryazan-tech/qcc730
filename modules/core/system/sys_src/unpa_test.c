...
static unpa_resource_state unpa_tr1_driver_fcn(unpa_resource *resource, unpa_client *client, unpa_resource_state state)
{
    return state;
}

static unpa_resource_definition unpa_tr1_def = {
    "ut/tr1", unpa_max_update_fcn, unpa_tr1_driver_fcn, 100, UNPA_CLIENT_DEFAULT, UNPA_RESOURCE_DEFAULT, NULL,
};

void unpa_test_query_verify(unpa_query_handle qh, unpa_query_id id, uint32_t expected)
{
...
void unpa_test(void)
{
    ...
    unpa_tc3 = unpa_create_client("unpatc3", UNPA_CLIENT_SUPPRESSIBLE, "ut/tr1");
