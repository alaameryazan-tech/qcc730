...
from sectools.features.isc.signer.defines import ENV_SIGNING_SERVER_HOST_TAG, ENV_SIGNING_SERVER_PORT_TAG

# Name & version of the tool
SECTOOLS_BUILDER_TOOL_NAME = 'Sectools Builder'
SECTOOLS_BUILDER_TOOL_VERSION = 'v3.3'
...
class BuilderInputPackage(object):
    ...
    def __str__(self):
        ...
        return "~~~~~~~~~~~~~~~BuilderInputPackage~~~~~~~~~~~~~~~" + "\n" + \
               ...
               "anti_rollback_version: " + to_string(self.anti_rollback_version) + "\n" + \
               "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
...
class BuilderParser(CoreOptionParser):
    ...
    def c_add_options(self):
        ...
        self.add_option("--anti_rollback_version", metavar="<hex>", default=None,
                        help="Value to override config file's anti_rollback_version value.")
...
"""
    ...
    selected_cert_config, config_type, client_id, lib_id, multi_serial_numbers, port, host, serial_number,
    platform_binding, and anti_rollback_version are utilized by builder. The remaining parameters are ignored and are
    only present to preserve backwards compatibility with build scripts using previous versions of Sectools Builder.
