...
nt_devcfg_header_output_dir=r"../../../../include"
...
os.system("python xml_combine_debug.py ?.xml > all_xml_modules_to_cat.xml")
...
if os.path.exists(os.path.join(nt_devcfg_header_output_dir,"nt_devcfg.h")):
    os.remove(os.path.join(nt_devcfg_header_output_dir,"nt_devcfg.h"))
if os.path.exists(os.path.join(nt_devcfg_header_output_dir,"nt_devcfg_byte_seq.h")):
    os.remove(os.path.join(nt_devcfg_header_output_dir,"nt_devcfg_byte_seq.h"))
if os.path.exists(
...
if os.path.exists(os.path.join(nt_devcfg_header_output_dir,"nt_devcfg.h")):
    os.remove(os.path.join(nt_devcfg_header_output_dir,"nt_devcfg.h"))
append_files("Names.h", os.path.join(nt_devcfg_header_output_dir,"nt_devcfg.h"))
...
if os.path.exists(os.path.join(nt_devcfg_header_output_dir,"nt_devcfg_byte_seq.h")):
    os.remove(os.path.join(nt_devcfg_header_output_dir,"nt_devcfg_byte_seq.h"))
append_files("byte_enum.h", os.path.join(nt_devcfg_header_output_dir,"nt_devcfg_byte_seq.h"))
