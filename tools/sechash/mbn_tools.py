...
def verify_elf_header(elf_header):
   if (elf_header.e_ident[ELFINFO_MAG0_INDEX].to_bytes(1,'little').decode('utf-8') != ELFINFO_MAG0) or \
      (elf_header.e_ident[ELFINFO_MAG1_INDEX].to_bytes(1,'little').decode('utf-8') != ELFINFO_MAG1) or \
      (elf_header.e_ident[ELFINFO_MAG2_INDEX].to_bytes(1,'little').decode('utf-8') != ELFINFO_MAG2) or \
      (elf_header.e_ident[ELFINFO_MAG3_INDEX].to_bytes(1,'little').decode('utf-8') != ELFINFO_MAG3) or \
      ((elf_header.e_ident[ELFINFO_CLASS_INDEX].to_bytes(1,'little').decode('utf-8') != ELFINFO_CLASS_64) and \
       (elf_header.e_ident[ELFINFO_CLASS_INDEX].to_bytes(1,'little').decode('utf-8') != ELFINFO_CLASS_32)) or \
      (elf_header.e_ident[ELFINFO_VERSION_INDEX].to_bytes(1,'little').decode('utf-8') != ELFINFO_VERSION_CURRENT):
